...
function syncGraphics(name, files, dir) {
   ...
   fs.writeFileSync("static/js/Data/Materials.json", JSON.stringify(materials));
}
...
function listGraphics(name, display_log) {
    ...
    var materials_file = getMaterials()[name],
        ...
        path = "static/js/Graphics/" + toFirstUppercase(name),
...
program
  ...
  .action(function() {
    ...
    var root = ["Audio", "Graphics", "core", "plugins", "Data", "src"],
        ...
        createDir(root, "");
        createDir(data, "static/js/Data/");
        createDir(audio, "static/js/Audio/");
        createDir(graphics, "static/js/Graphics/");
        fs.mkdirSync("static/js/core/scene");
