RPGJS_Canvas.Scene.New({
	...
	materials: {
		images: {
			background: "../static/js/Graphics/Pictures/Layer00.png",
			button: "../static/js/Graphics/Pictures/Sprite_Button.png",
			party: "../static/js/Graphics/Pictures/Sprite_Status.png",
			hp: "../static/js/Graphics/Pictures/HP.png",
			sp: "../static/js/Graphics/Pictures/SP.png",
			/*face: "Graphics/Faces/Aluxes.png",
			battler: "Graphics/Battlers/Aluxes.png",*/
			gold: "../static/js/Graphics/Icons/gold.png",
			icon: "../static/js/Graphics/Icons/time.png"
		}
	},
