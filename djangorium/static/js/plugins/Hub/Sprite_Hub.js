Class.create("Sprite_Hub", {
	...
	mapLoadImages: function(array) {
		...
		// [CUSTOM_PATH]
		array.push(RPGJS.Path.getFile("pictures", "../../../static/js/Graphics/Pictures/hub.png", "hub"));
		array.push(RPGJS.Path.getFile("pictures", "../../../static/js/Graphics/Pictures/hp_meter.png", "hp_meter"));
		array.push(RPGJS.Path.getFile("pictures", "../../../static/js/Graphics/Pictures/hp_number.png", "hp_number"));
		array.push(RPGJS.Path.getFile("pictures", "../../../static/js/Graphics/Pictures/Hero_Face.png", "hero_face"));
		array.push(RPGJS.Path.getFile("pictures", "../../../static/js/Graphics/Pictures/button_A.png", "button_a"));
		array.push(RPGJS.Path.getFile("pictures", "../../../static/js/Graphics/Pictures/button_B.png", "button_b"));
